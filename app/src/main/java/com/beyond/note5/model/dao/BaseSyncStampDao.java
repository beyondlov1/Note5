...
/** 
 * DAO for table "BASE_SYNC_STAMP".
*/
public class BaseSyncStampDao extends AbstractDao<BaseSyncStamp, String> {

    public static final String TABLENAME = "BASE_SYNC_STAMP";

    /**
     * Properties of entity BaseSyncStamp.<br/>
    ...
    public BaseSyncStampDao(DaoConfig config) {
        super(config);
    }
    
    public BaseSyncStampDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BASE_SYNC_STAMP\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BASE_SYNC_STAMP\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BaseSyncStamp entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BaseSyncStamp entity) {
        stmt.clearBindings();
    ...
    @Override
    public BaseSyncStamp readEntity(Cursor cursor, int offset) {
        BaseSyncStamp entity = new BaseSyncStamp( //
    ...
    @Override
    public void readEntity(Cursor cursor, BaseSyncStamp entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(BaseSyncStamp entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(BaseSyncStamp entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BaseSyncStamp entity) {
