...
/** 
 * DAO for table "TRACE_LOG".
*/
public class TraceLogDao extends AbstractDao<TraceLog, String> {

    public static final String TABLENAME = "TRACE_LOG";

    /**
     * Properties of entity TraceLog.<br/>
    ...
    public TraceLogDao(DaoConfig config) {
        super(config);
    }
    
    public TraceLogDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRACE_LOG\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TRACE_LOG\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TraceLog entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TraceLog entity) {
        stmt.clearBindings();
    ...
    @Override
    public TraceLog readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, TraceLog entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(TraceLog entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(TraceLog entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TraceLog entity) {
