...
/** 
 * DAO for table "SYNC_STATE_INFO".
*/
public class SyncStateInfoDao extends AbstractDao<SyncStateInfo, String> {

    public static final String TABLENAME = "SYNC_STATE_INFO";

    /**
     * Properties of entity SyncStateInfo.<br/>
    ...
    public SyncStateInfoDao(DaoConfig config) {
        super(config);
    }
    
    public SyncStateInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SYNC_STATE_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SYNC_STATE_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SyncStateInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SyncStateInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public SyncStateInfo readEntity(Cursor cursor, int offset) {
        SyncStateInfo entity = new SyncStateInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, SyncStateInfo entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(SyncStateInfo entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(SyncStateInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SyncStateInfo entity) {
